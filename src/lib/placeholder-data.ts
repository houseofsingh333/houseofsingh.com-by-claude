...
export const fallbackAboutPage: AboutPageData = {
  ...
  featuredOn: [
    {
      name: "Design Milk",
      title: "House of Singh: Where Craft Meets Quiet Intention",
      date: "2025-09-12",
      description: "An in-depth profile on the studio's approach to blending editorial design with cultural storytelling.",
      url: "https://design-milk.com",
      logo: "/images/logo-design-milk.svg",
      image: "/images/project-placeholder-1.svg",
    },
    {
      name: "It\u2019s Nice That",
      title: "The Sikh Turban — A Visual Celebration of Identity",
      date: "2025-06-03",
      description: "How a personal project became an international conversation about heritage and visual culture.",
      url: "https://itsnicethat.com",
      logo: "/images/logo-its-nice-that.svg",
      image: "/images/project-placeholder-2.svg",
    },
    {
      name: "Communication Arts",
      title: "Typography and Restraint in Modern Brand Systems",
      date: "2024-11-20",
      description: "Selected for the annual design review — a recognition of typographic craft and measured visual identity work.",
      url: "https://commarts.com",
      logo: "/images/logo-comm-arts.svg",
      image: "/images/project-placeholder-3.svg",
    },
    {
      name: "The Dieline",
      title: "Grain & Thread — Packaging Rooted in Artisan Tradition",
      date: "2024-08-15",
      description: "A look at the packaging system designed for an artisan textile studio, balancing heritage with contemporary form.",
      url: "https://thedieline.com",
      logo: "/images/logo-the-dieline.svg",
      image: "/images/hero-placeholder-1.svg",
    },
  ],
  milestones: [
